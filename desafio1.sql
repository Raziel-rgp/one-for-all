DROP DATABASE IF EXISTS SpotifyClone;
  ...
  INSERT INTO SpotifyClone.plano (plano_id, nome_plano, preco)
  VALUES
    (1, 'Gratuito', 0),
  ...
  INSERT INTO SpotifyClone.albuns(nome_album, artista_id, lancamento)
  VALUES
  ('Renaissance', 1, 2022),
  ('Jazz', 2, 1978),
  ('Hot Space', 2, 1978),
  ...
  INSERT INTO SpotifyClone.musicas(album_id, nome_musica, artista_id, duracao_segundos)
  VALUES
  (1, 'BREAK MY SOUL', 1, 279),
  (1, 'VIRGO’S GROOVE', 1, 369),
  (1, 'ALIEN SUPERSTAR', 1, 116),
  (2, 'Don’t Stop Me Now', 2, 203),
  (3, 'Under Oressure', 2, 152),
  ...
  INSERT INTO SpotifyClone.historico_usuario(usuario_id, musica_id, data_reproducao)
  VALUES
